...
class vec3 {
  public:
    ...
    inline static vec3 random(double min, double max, pcg32& rng) {
...
inline vec3 random_in_unit_sphere(pcg32& rng) {
    while (true) {
...
inline vec3 random_in_hemisphere(const vec3& normal, pcg32& rng) {
